...
# ====================================================================
#DATA_PATH=$(tr "\n" " " < "$MIX_FILE")
DATA_PATH="/pfs/lustrep4/scratch/project_462000963/preprocessed/oellm-v1-128k/catalogue/nemotron-cc/1.0/20p-sample/high-actual-20p"
DATA_CACHE_PATH="/scratch/project_462000963/users/$USER/test_output/data_cache_${EXP_NAME}"
TOKENIZER_MODEL="openeurollm/tokenizer-128k"
