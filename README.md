...
training data can be found here: /scratch/project_465002530/preprocessed/oellm-v1-256k/catalogue/
...
# TODO
fix training script to fit the 60m parameter model config from olmix
